...
class SimpleKeyTeleop():
    ...
    def run(self):
        ...
        while self._man_running:
            ...
            self._publish()
            rate.sleep()
        #AUTORUN: Make autorun loop here
    ...
    def _key_pressed(self, keycode):
        if keycode == ord('q'):
            ...
            #Toggle auto and manual operation using v
            #self._man_running = False
            #self._auto_run = True
            rospy.loginfo('Force Mode: ON')
            #VISION: placeholder for vision stuff
            pass
